            ...
            <div className="card h-100 p-0">
                ...
                <div className="card-body py-16 px-24 d-flex flex-wrap align-items-center gap-3">
                    <div className="btn-group radius-8" role="group" aria-label="Default button group">
                        <button type="button" className="btn btn-primary-600 radius-8 px-20 py-11 d-flex align-items-center gap-2">
                            <Icon
                        ...
                        <button type="button" className="btn btn-primary-600 px-20 py-11 radius-8">
                            Right
                        </button>
                    </div>
                    <div
